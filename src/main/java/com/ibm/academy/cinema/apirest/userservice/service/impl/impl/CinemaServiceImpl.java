...
import com.ibm.academy.cinema.apirest.userservice.repository.CinemaRepository;
...
public class CinemaServiceImpl implements CinemaService {
    ...
    public CinemaDto create(UserDto cinemaDto) {
        ...
        if (userRepository.existsByEmail(cinemaDto.getEmail()) || userRepository.existsByUsername(cinemaDto.getUsername()))
